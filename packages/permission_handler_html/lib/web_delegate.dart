...
class WebDelegate {
  ...
  Future<bool> _requestMicrophonePermission() async {
    ...
    try {
      ...
      final web.MediaStream? mediaStream = await mediaStreamPromise.toDart;
      ...
      if (mediaStream?.active ?? false) {
        final audioTracks = mediaStream?.getAudioTracks().toDart ?? const [];
  ...
  Future<bool> _requestCameraPermission() async {
    ...
    try {
      ...
      web.MediaStream? mediaStream = await mediaStreamPromise.toDart;
      ...
      if (mediaStream?.active ?? false) {
        final videoTracks = mediaStream?.getVideoTracks().toDart ?? const [];
